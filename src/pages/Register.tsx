        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-12">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField control={form.control} name="wasteTypes" render={({
                field
              }) => <FormItem>
                ...
                field
                      ...
                      <FormControl>
                        <Textarea placeholder="Tell us about your organization and recycling services" className="min-h-[120px]" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
          ...
          <div className="space-y-10">
            <div>
              ...
              {registrations.length > 0 ? <div className="bg-white rounded-lg shadow overflow-hidden">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {registrations.map((org, idx) => <tr key={idx}>
                ...
                </div> : <div className="bg-white p-6 rounded-lg shadow text-center text-gray-500">
            ...
            <div>
              ...
              <div className="bg-white rounded-lg shadow overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {pickups.map(pickup => <tr key={pickup.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${pickup.status === 'Confirmed' ? 'bg-green-100 text-green-800' : pickup.status === 'Completed' ? 'bg-blue-100 text-blue-800' : 'bg-yellow-100 text-yellow-800'}`}>
                            {pickup.status}
                          </span>
                        </td>
                      </tr>)}
