...
const Hero = () => {
  ...
  return <section className="relative min-h-[80vh] flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 bg-transparent">
        <h1 className="text-4xl font-bold mb-6 bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600 bg-clip-text drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-gray-200 md:text-6xl">Join the Green Movement</h1>
